...
impl<'a> NodeContext<'a> {
    ...
    pub fn draw_rect(&mut self, position: Vec2, size: Vec2, color: gd_core::Color) {
...
/// The fundamental building block of the engine, mirroring Godot's `Node`.
///
...
/// A plain node with no built-in behaviour — the equivalent of Godot's bare
